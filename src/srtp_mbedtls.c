/* libvham/src/srtp_mbedtls.c — DTLS-SRTP via mbedtls + libsrtp.
 *
 * Built only when VHAM_WITH_DTLS_MBEDTLS is defined (configure script
 * sets this when ./configure picked mbedtls as the DTLS backend).
 *
 * Provides:
